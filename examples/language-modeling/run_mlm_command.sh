...
python run_mlm.py --model_name_or_path emilyalsentzer/Bio_ClinicalBERT --output_dir out_mimic_clinicalbert --overwrite_output_dir --line_by_line --train_file sample_data.txt --validation_file sample_data.txt --do_train --max_seq_length 128
